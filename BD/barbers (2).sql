...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-08-2022 a las 08:43:38
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SpEditarUsuario` (IN `_CEDULA` INT(15), IN `_NOMBRE` VARCHAR(30), IN `_APELLIDO` VARCHAR(30), IN `_NUM_CELULAR` INT(15), IN `_F_NACIMIENTO` DATE, IN `_EMAIL` VARCHAR(30))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SpInsertarUsuario` (IN `_CEDULA` INT(15), IN `_NOMBRE` VARCHAR(30), IN `_APELLIDO` VARCHAR(30), IN `_NUM_CELULAR` INT(15), IN `_F_NACIMIENTO` DATE, IN `_EMAIL` VARCHAR(30), IN `_CONTRASENA` VARCHAR(30))  BEGIN
INSERT INTO usuarios (CEDULA, NOMBRE, APELLIDO, NUM_CELULAR, F_NACIMIENTO, EMAIL, CONTRASENA ) VALUES (_CEDULA, _NOMBRE, _APELLIDO,  _NUM_CELULAR, _F_NACIMIENTO, _EMAIL,md5(_CONTRASENA));
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SpVerUsuario` ()  BEGIN
    ...
    SELECT `CEDULA`, `NOMBRE`, `APELLIDO`,`NUM_CELULAR`, 					`F_NACIMIENTO`, `EMAIL` FROM `usuarios`;
...
(14489665, 'julia', 'rubiano', 31156655, '2022-08-09', 'a@g.com', '202cb962ac59075b964b07152d234b70'),
(47786753, 'luis', 'roa', 1453463, '2022-08-08', 'j@gmail.com', 'e10adc3949ba59abbe56e057f20f883e'),
(145165165, 'camilo', 'perez', 165198419, '2022-08-03', 'ca@g.com', '25f9e794323b453885f5181f1b624d0b'),
(445566633, 'camila', 'lopez', 2147483647, '2022-08-02', 'ca@g.com', 'e10adc3949ba59abbe56e057f20f883e');
